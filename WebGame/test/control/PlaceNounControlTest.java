 ...
 * @author Bryan
 */
public class PlaceNounControlTest {
    
    public PlaceNounControlTest() {
    }

    @Test
    public void testPlaceNounHttpObject() throws Exception {
        
        PlaceNounControl control = new PlaceNounControl();
        StringBuilder test1 = control.httpPlaceNounBuilder();
