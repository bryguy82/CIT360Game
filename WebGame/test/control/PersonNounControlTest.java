 ...
 * @author Bryan
 */
public class PersonNounControlTest {
    
    public PersonNounControlTest() {
    }

    @Test
    public void testPersonNounHttpObject() throws Exception {
        
        PersonNounControl control = new PersonNounControl();
        StringBuilder test1 = control.httpPersonNounBuilder();
        ...
        assertEquals(testObj2[8], "mother");
    }
}
