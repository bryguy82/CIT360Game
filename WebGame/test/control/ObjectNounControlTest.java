...
public class ObjectNounControlTest {
    ...
    @Test
    public void testObjectNounHttpObject() throws Exception {
        
        ObjectNounControl control = new ObjectNounControl();
        StringBuilder test1 = control.httpObjectNounBuilder();
